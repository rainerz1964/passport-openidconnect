...
Strategy.prototype.authenticate = function(req, options) {
  ...
  if (req.query && req.query.code) {
    ...
    function loaded(err, ok, state) {
      ...
      if (self._pkce) {
        authenticationParams['code_verifier'] = self.verifier;
      }
    ...
    this._setup(identifier, function(err, config) {
      ...
      if (self._pkce) {
        self.verifier = base64URLEncode(crypto.randomBytes(32));
        params['code_challenge'] = base64URLEncode(sha256(verifier));
